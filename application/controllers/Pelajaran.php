...
class Pelajaran extends CI_Controller
{
    ...
    {
        $this->template->load('template','pelajaran/tbl_pelajaran_list');
    } 
    ...
    public function read($id) 
    {
		...
		'jam_selesai' => $row->jam_selesai,
            ...
            $this->template->load('template','pelajaran/tbl_pelajaran_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','pelajaran/tbl_pelajaran_form', $data);
    }
    ...
    public function update_action() 
    {
        ...
        'mapel'         => $this->input->post('mapel',TRUE),
            ...
            $this->Pelajaran_model->update($this->input->post('id_mapel', TRUE), $data);
	...
	foreach ($this->Pelajaran_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'tbl_pelajaran_data' => $this->Pelajaran_model->get_all(),
            'start' => 0
        );
